...
/*
    to improve this and make it more readable, create seperate functions for many of these conditions. Perhaps feed entry.data 
...
*/
    private filterLatestReadings(overviewData: PatientResponseDataInterfaces[], metric: string): any {
        ...
        overviewData.forEach((day) => {
            ...
            //if the recentMetrics is today and the last one done just return; if not, check if the last readings was today
